    ...
    >
      <div className="flex justify-center w-full">
        <div className="flex justify-between min-w-[300px] lg:w-[500px]">
          <button
            className="w-32 lg:w-52 bg-white h-32 lg:h-52 rounded-[50%] flex justify-center items-center border-[1rem] lg:border-[1.7rem] border-[var(--colorPaper)] transition transform hover:scale-110 active:scale-90 shadow-inner shadow-[var(--colorHeaderOutline)]"
            onClick={() => escolher("papel")}
          >
            <img src={data.iconPaper} className="lg:w-16" alt="Paper" />
          </button>
          <button
            className="w-32 lg:w-52 bg-white h-32 lg:h-52 rounded-[50%] flex justify-center items-center border-[1rem] lg:border-[1.7rem] border-[var(--colorScissors)] transition transform hover:scale-110 active:scale-90 shadow-inner shadow-[var(--colorHeaderOutline)]"
      ...
      <div className="flex justify-center">
        <button
          className="w-32 lg:w-52 bg-white h-32 lg:h-52 rounded-[50%] flex justify-center items-center border-[1rem] lg:border-[1.7rem] border-[var(--colorRock)] transition transform hover:scale-110 active:scale-90 shadow-inner shadow-[var(--colorHeaderOutline)]"
