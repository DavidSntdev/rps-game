...
function GameResult({
  ...
  const [isGameover, setGameover] = useState<boolean>(false); // botar no app depois, ta resetando toda hora que mete rules
  const [showEscolhaJ1, setShowEscolhaJ1] = useState<boolean>(false);
  ...
  useEffect(() => {
    if (showEscolhaJ2 && showEscolhaJ1) {
  ...
  }, [showEscolhaJ1, showEscolhaJ2, escolhaJ2]);
        ...
        {pvp ? (
          ...
          >
            <motion.div
              ...
              animate={{
                scale: showEscolhaJ1 ? 1 : 0.5,
                opacity: showEscolhaJ1 ? 1 : 0,
              }}
              transition={{ duration: 0.8 }}
            >
              {showEscolhaJ1 && (
